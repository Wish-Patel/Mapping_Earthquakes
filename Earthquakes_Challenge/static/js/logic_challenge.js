...
// We create the street that will be the background of our map.
...
// We create the satellite layer that will be an option for our map.
...
// Create the overlay layer for our map.
...
//Define eatherquakes and techtonic plates data
...
d3.json(earthquakeData).then(function (data) {
    ...
    // Then we add the legend to our map.
    legend.addTo(map);
});
